...
const hideLoadingBlock = () => {
    if (loadingBlock) {
        loadingBlock.getElementsByClassName.visibility = 'hidden';
    }
};

const showLoadingBlock = () => {
    if (loadingBlock) {
        loadingBlock.getElementsByClassName.visibility = 'visible';
    }
...
filterInput.addEventListener('keyup', function(event) {
    ...
    loadTowns().then(towns => {
        ...
        const resultTowns = towns.filter(town => isMatching(town.name, value));
